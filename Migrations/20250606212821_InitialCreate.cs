        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Bicycle_HasHelmet = table.Column<bool>(type: "bit", nullable: true),
                    HasLock = table.Column<bool>(type: "bit", nullable: true),
                    ...
                    HasHelmet = table.Column<bool>(type: "bit", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PixKey = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Vehicles_Available_Status",
                table: "Vehicles",
                columns: new[] { "Available", "Status" });
